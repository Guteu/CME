...
const Bimestre2 = (props) => {
    ...
    const provasInfo = {
        pe: { minimo: 0, maximo: 47, nome: "Produção Escrita (47)" },
    ...
    function calcularNota() {
        ...
        let calcUSHistory = '((materias[materiasArray[i]]["pe"] / 4.7 * 3) + ((materias[materiasArray[i]]["ne"] / 10) * 5) + materias[materiasArray[i]]["no"] * 2) / 10';
            ...
            <div className="responsiveTable">
                <table>
                    ...
                    <tbody onChange={pegarNotas}>
                        ...
                        <tr>
                            <td><div>Produção Escrita (47) </div><input type="number" className="hist" name="pe" /></td>
                        </tr>
