    ...
    function calcularNota() {
        ...
        for (let i = 0; i < materiasArray.length; i++) {
            ...
            if (materias[materiasArray[i]].calc == "normal") {
                ...
                newNotas[materiasArray[i]].nota = materias[materiasArray[i]]["hum"] * 5;
            }
        }
        ...
        <>
                ...
                <table>
                    ...
                    <tbody onChange={pegarNotas}>
                        ...
                        <tr>
                            ...
                            <td><div>AD </div><input type="number" className="geo" name="adHum" /></td>
            ...
            <div className='responsiveTable'>
                <table>
                    ...
                    <tbody onChange={pegarNotas}>
                        <tr>
                            <td><div>AP </div><input type="number" className="fil" name="adHum" /></td>
                            <td><div>AP </div><input type="number" className="soc" name="adHum" /></td>
