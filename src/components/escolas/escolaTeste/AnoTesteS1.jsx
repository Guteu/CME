...
const AnoTesteS1 = (props) => {
    ...
    function calcularNota(){
        ...
        let calcBio = '(materias[materiasArray[i]]["prova-1"] + materias[materiasArray[i]]["prova-2"] + materias[materiasArray[i]]["prova-3"] + materias[materiasArray[i]]["prova-4"])/4'
            ...
            <table>
                ...
                <tbody onChange={pegarNotas}>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><div>prova 4:</div> <input type="number" className="bio" name="prova-4" id="" /> </td>
                    </tr>
                </tbody>
            </table>
        </div>
